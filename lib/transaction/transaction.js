...
Transaction.MAX_MONEY = 100000000 * 1e8; // Unitedcoin has 84M coins
...
Transaction.FEE_PER_KB = 100000; // Unitedcoin default fees is 0.001 LTC
...
Transaction.prototype.checkedSerialize = function(opts) {
  ...
  if (serializationError) {
    serializationError.message += ' Use Transaction#uncheckedSerialize if you want to skip security checks. ' +
      'See http://unitedcore.io/guide/transaction.html#Serialization for more info.';
 ...
 * and a slightly fancier format recognized by unitedcore:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a unitedcore Address object. The
 * same is true for `script`, which can be a string or a unitedcore Script.
 *
