...
* [Peer to Peer Networking](https://github.com/coinshaz/unitedcore-p2p)
* [Unitedcoin Core JSON-RPC](https://github.com/bitpay/unitedcoind-rpc)
...
var imported = unitedcore.PrivateKey.fromWIF(exported);
...
var p2shAddress = new unitedcore.Address([publicKey1, publicKey2, publicKey3], 2);
```
...
var uri = new unitedcore.URI(paymentInfo).toString();
```
